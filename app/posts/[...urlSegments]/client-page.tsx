  ...
  return (
    <ErrorBoundary>
      <Section className='px-4'>
        ...
        <div data-tina-field={tinaField(post, '_body')} className='prose prose-lg dark:prose-invert font-playfair prose-headings:font-playfair prose-headings:text-black dark:prose-headings:text-white prose-headings:font-semibold prose-h1:text-black dark:prose-h1:text-white prose-h2:text-black dark:prose-h2:text-white prose-h3:text-black dark:prose-h3:text-white prose-p:text-black dark:prose-p:text-white prose-strong:text-black dark:prose-strong:text-white prose-strong:font-semibold prose-a:text-black dark:prose-a:text-white prose-a:underline prose-a:decoration-black/40 dark:prose-a:decoration-white/40 hover:prose-a:decoration-black/60 dark:hover:prose-a:decoration-white/60 prose-code:text-black dark:prose-code:text-white prose-code:bg-black/5 dark:prose-code:bg-white/10 prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-code:text-sm prose-pre:bg-black/5 dark:prose-pre:bg-white/10 prose-pre:border prose-pre:border-black/10 dark:prose-pre:border-white/20 prose-blockquote:border-l-black/30 dark:prose-blockquote:border-l-white/40 prose-blockquote:text-black dark:prose-blockquote:text-white prose-blockquote:bg-black/5 dark:prose-blockquote:bg-white/10 prose-blockquote:pl-4 prose-blockquote:py-2 prose-blockquote:my-4 prose-li:text-black dark:prose-li:text-white prose-ul:text-black dark:prose-ul:text-white prose-ol:text-black dark:prose-ol:text-white prose-li:marker:text-black dark:prose-li:marker:text-white w-full max-w-none'>
          <TinaMarkdown
            content={post._body}
            components={{
              ...components,
